...
A CUDA kernel for the pairwise Euclidean distance matrix, exposed to NumPy through [nanobind](https://nanobind.readthedocs.io/) and built with [scikit-build-core](https://scikit-build-core.readthedocs.io/).
