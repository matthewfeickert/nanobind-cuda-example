...
```{literalinclude} ../templates/03-nanobind-cuda/src/gpu-pairwise/src/pairwise.cu
:filename: templates/03-nanobind-cuda/src/gpu-pairwise/src/pairwise.cu
:language: cpp
:lines: 22-36
```
...
```{literalinclude} ../templates/03-nanobind-cuda/src/gpu-pairwise/src/gpu_pairwise/__init__.py
:filename: templates/03-nanobind-cuda/src/gpu-pairwise/src/gpu_pairwise/__init__.py
:language: python
:linenos:
```
...
```{literalinclude} ../templates/03-nanobind-cuda/src/gpu-pairwise/tests/test_pairwise.py
:filename: templates/03-nanobind-cuda/src/gpu-pairwise/tests/test_pairwise.py
:language: python
:linenos:
```
