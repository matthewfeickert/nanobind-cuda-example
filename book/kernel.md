...
```{literalinclude} ../src/gpu-pairwise/src/pairwise.cu
:filename: src/gpu-pairwise/src/pairwise.cu
:language: cpp
:lines: 22-36
```
...
```{literalinclude} ../src/gpu-pairwise/src/gpu_pairwise/__init__.py
:filename: src/gpu-pairwise/src/gpu_pairwise/__init__.py
:language: python
:linenos:
```
...
```{literalinclude} ../src/gpu-pairwise/tests/test_pairwise.py
:filename: src/gpu-pairwise/tests/test_pairwise.py
:language: python
:linenos:
```
